...
echo " ${YELLOW}Enter your ZELNODE PRIVATE KEY generated by your Swing/Zelcore wallet"
...
cd /usr/local/bin && sudo rm $COIN_CLI $COIN_DAEMON > /dev/null 2>&1 && sleep 2 && cd

sudo rm -rf $EXTRACT_DIR
sudo rm -rf $WALLET_TAR_FILE
sudo wget -c $WALLET_DOWNLOAD -O - | sudo tar -xvzf -C $COIN_PATH
...
echo " ${YELLOW}Basic security completed..."
...
echo "ZN1 ${YELLOW}$WANIP:$PORT ${NC}$zelnodeprivkey TxID OUTPUT"
echo "COURTESY OF ${YELLOW}ALTTANK FAM ${NC}AND ${YELLOW}DK808"
echo "============================================================================="
sleep 1
