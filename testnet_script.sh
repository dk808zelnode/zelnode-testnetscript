...
#wallet information
WALLET_DOWNLOAD='https://www.dropbox.com/s/vle3slcwfsmrh3w/zelnodetestnet-linux.tar.gz'
...
echo -e "${YELLOW}Enter your ZELNODE PRIVATE KEY generated by your Swing/Zelcore wallet"
...
echo -e "${YELLOW}Basic security completed..."
...
echo -e "ZN1 ${YELLOW}$WANIP:$PORT ${NC}$zelnodeprivkey TxID OUTPUT"
